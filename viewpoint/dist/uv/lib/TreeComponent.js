...
(function (IIIFComponents) {
	var TreeComponent = /** @class */ (function (_super) {
		...
		TreeComponent.prototype.set = function (data) {
			...
			if (multiSelectState) {
				var _loop_1 = function (i) {
					...
					var node = this_1
						._getMultiSelectableNodes()
						.en()
						.where(function (n) {
							return n.data.id === range.id;
						})
						.first();
					if (node) {
		...
		TreeComponent.prototype._getMultiSelectableNodes = function () {
			...
			return (this._multiSelectableNodes = this._getAllNodes()
				.en()
				.where(function (n) {
		...
		TreeComponent.prototype._getAllNodes = function () {
			...
			return (this._allNodes = this._rootNode.nodes
				.en()
				.traverseUnique(function (node) {
					return node.nodes;
				})
				.toArray());
		};
		TreeComponent.prototype.getMultiSelectedNodes = function () {
			...
			return this._getAllNodes()
				.en()
				.where(function (n) {
					return _this._nodeIsMultiSelectable(n) && n.multiSelected;
				})
				.toArray();
		};
